...
final class BookmarkManager {
    ...
    func existingBookmark(for episode: BaseEpisode, at time: TimeInterval) -> Bookmark? {
        dataManager.existingBookmark(forEpisode: episode.uuid, time: time)
    }
