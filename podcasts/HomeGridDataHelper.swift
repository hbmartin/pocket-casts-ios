...
nonisolated class HomeGridDataHelper {
    ...
    class func gridListItemsForSearchTerm(_ searchTerm: String) -> [HomeGridItem] {
        ...
        class func gridListItems(orderedBy: LibrarySort, badgeType: BadgeType) -> [HomeGridListItem] {
            ...
            let gridItems: [HomeGridListItem] = gridItems(orderedBy: orderedBy, sortedPodcasts: allPodcasts).map { HomeGridListItem(gridItem: $0, badgeType: badgeType, theme: Theme.sharedTheme.nonisolatedActiveTheme) }
