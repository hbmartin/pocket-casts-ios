...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private let readAloudCoordinator = ReadAloudCoordinator()
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        // No-op unless the Read Aloud flag is on; resumes any narration a
        // previous launch left unfinished.
        readAloudCoordinator.setup()
    ...
    func handleEnterBackground() {
        ...
        readAloudCoordinator.handleEnterBackground()
        if FeatureFlag.diarizedTranscription.enabled {
    ...
    func handleBecomeActive() {
        ...
        readAloudCoordinator.handleAppBecameActive()
