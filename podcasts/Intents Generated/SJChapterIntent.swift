...
nonisolated public class SJChapterIntent: INIntent {

    @NSManaged public var skipForward: SJNextPrevious
}
...
public protocol SJChapterIntentHandling: NSObjectProtocol {
    ...
    @objc(handleChapter:completion:)
    func handle(intent: SJChapterIntent) async -> SJChapterIntentResponse
    ...
    @available(iOS 13.0, macOS 11.0, watchOS 6.0, *)
    @objc(confirmChapter:completion:)
    optional func confirm(intent: SJChapterIntent) async -> SJChapterIntentResponse
}
...
nonisolated public class SJChapterIntentResponse: INIntentResponse {
