...
class PodcastSettingsViewController: PCViewController {
    ...
    enum TableRow { case autoDownload, notifications, localTranscriptionOnly, upNext, globalUpNext, upNextPosition, playbackEffects, skipFirst, skipLast, skipChapters, autoArchive, inFilters, unsubscribe, feedError }
