...
nonisolated extension SettingsStore<AppSettings> {
    ...
    func importUserDefaults(_ userDefaults: UserDefaults = UserDefaults.standard) {
        ...
        self.update(\.$headphoneControlsNextAction, value: HeadphoneControl(action: Constants.UserDefaults.headphones.nextAction.value))
        self.update(\.$headphoneControlsPreviousAction, value: HeadphoneControl(action: Constants.UserDefaults.headphones.previousAction.value))
