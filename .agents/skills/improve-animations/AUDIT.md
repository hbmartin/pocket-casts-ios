...
Duration budgets — **300ms is the default maximum for UI animations; modal and drawer transitions are explicit exceptions and may use up to 500ms when appropriate**:
