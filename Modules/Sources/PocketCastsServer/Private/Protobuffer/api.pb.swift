...
struct Api_SupportFeedbackRequest: Sendable {
  ...
  // Fork extension (fields 6-9, mirrored in podcast-backend/protos/api.proto):
  // structured diagnostics for shake-to-report.

  var logs: String = String()

  var bitdriftSessionID: String = String()
...
extension Api_SupportFeedbackRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  // Hand-extended (fields 6-9): the classic dictionary NameMap replaces the
  // generated bytecode form because the fork's diagnostics fields are appended
  // manually — see podcast-backend/protos/api.proto for the wire contract.
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    5: .same(proto: "inbox"),
    6: .same(proto: "logs"),
    7: .standard(proto: "bitdrift_session_id"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularStringField(value: &self.logs) }()
      case 7: try { try decoder.decodeSingularStringField(value: &self.bitdriftSessionID) }()
      case 8: try { try decoder.decodeSingularStringField(value: &self.deviceInfo) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.logs.isEmpty {
      try visitor.visitSingularStringField(value: self.logs, fieldNumber: 6)
    }
    if !self.bitdriftSessionID.isEmpty {
      try visitor.visitSingularStringField(value: self.bitdriftSessionID, fieldNumber: 7)
    }
    if !self.deviceInfo.isEmpty {
      try visitor.visitSingularStringField(value: self.deviceInfo, fieldNumber: 8)
    }
