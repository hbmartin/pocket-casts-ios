...
public final class EpisodeRepositoryMock: RepositoryMock, EpisodeRepository, @unchecked Sendable {
    ...
    public func bulkMarkAsPlayed(episodes: [Episode], updateSyncFlag: Bool) {
        record("bulkMarkAsPlayed(episodes:updateSyncFlag:)_Episode")
    }

    public func bulkMarkAsPlayed(episodes: [UserEpisode], updateSyncFlag: Bool) {
        record("bulkMarkAsPlayed(episodes:updateSyncFlag:)_UserEpisode")
    }
