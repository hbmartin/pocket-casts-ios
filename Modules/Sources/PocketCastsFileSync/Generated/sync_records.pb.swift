...
// Source: sync_records.proto
//
// For information on using the generated types, please see the documentation:
//   https://github.com/apple/swift-protobuf/

// Vendored reconstruction of the Pocket Casts sync record schema.
//
// The upstream project ships only generated Swift (PocketCastsServer's
// api.pb.swift); no .proto sources exist in the repository. This file was
// reconstructed field-by-field from that generated code so the on-disk
// file-sync format is wire-compatible with the records the app already
// uses, and so the format outlives any single server or codebase.
//
// Wire compatibility contract: field numbers and types of existing fields
// must never change. New fields use numbers >= 1000 to stay clear of any
...
public struct Api_SyncUserPodcast: Sendable {
  ...
  /// Fork extension (not part of the upstream schema): the podcast's RSS
  /// feed URL, so a future direct-RSS refresher needs no data migration.
...
public struct Api_SyncUserEpisode: Sendable {
  ...
  /// is_deleted is "archived" in app terms.
  public var isDeleted: SwiftProtobuf.Google_Protobuf_BoolValue {
    get {_isDeleted ?? SwiftProtobuf.Google_Protobuf_BoolValue()}
    set {_isDeleted = newValue}
  }
...
public struct Api_SyncUserBookmark: Sendable {
  ...
  /// Fork extension (not part of the upstream schema): smart-highlight
  /// enrichment — the transcript excerpt around the bookmark position and
  /// the end of that excerpt window (seconds, same domain as `time`).
  /// Merged last-writer-wins by op stamp (fields 1000/1001 in the snapshot
  /// stamp map): devices can compute different excerpts for the same
  /// bookmark, so a first-writer fill-in would diverge across replay orders.
  ...
  /// Highlights program (ADR-0016): user-authored trim + tags. A record
  /// whose trim_modified is set carries a user-edited window: excerpt and
  /// end_time apply together with the stamp, merged LWW by the STAMP (not
  /// the op order), and always beat un-stamped machine enrichment. Tags
  /// merge as a whole set, LWW by tags_modified; the set is only applied
  /// when the stamp is present.
  public var trimModified: SwiftProtobuf.Google_Protobuf_Int64Value {
    get {_trimModified ?? SwiftProtobuf.Google_Protobuf_Int64Value()}
    set {_trimModified = newValue}
  }
  /// Returns true if `trimModified` has been explicitly set.
  public var hasTrimModified: Bool {self._trimModified != nil}
  /// Clears the value of `trimModified`. Subsequent reads from it will return its default value.
  public mutating func clearTrimModified() {self._trimModified = nil}

  public var tags: [String] = []

  public var tagsModified: SwiftProtobuf.Google_Protobuf_Int64Value {
    get {_tagsModified ?? SwiftProtobuf.Google_Protobuf_Int64Value()}
    set {_tagsModified = newValue}
  }
  /// Returns true if `tagsModified` has been explicitly set.
  public var hasTagsModified: Bool {self._tagsModified != nil}
  /// Clears the value of `tagsModified`. Subsequent reads from it will return its default value.
  public mutating func clearTagsModified() {self._tagsModified = nil}
  ...
  fileprivate var _trimModified: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
  fileprivate var _tagsModified: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
}
...
extension Api_SyncUserPodcast: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}uuid\0\u{3}is_deleted\0\u{1}subscribed\0\u{3}auto_start_from\0\u{3}episodes_sort_order\0\u{3}auto_skip_last\0\u{3}folder_uuid\0\u{3}sort_position\0\u{3}date_added\0\u{1}settings\0\u{4}^\u{f}feed_url\0")
...
extension Api_SyncUserBookmark: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}bookmark_uuid\0\u{3}podcast_uuid\0\u{3}episode_uuid\0\u{3}created_at\0\u{1}time\0\u{1}title\0\u{3}title_modified\0\u{3}is_deleted\0\u{3}is_deleted_modified\0\u{2}_\u{f}excerpt\0\u{3}end_time\0\u{3}trim_modified\0\u{1}tags\0\u{3}tags_modified\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1002: try { try decoder.decodeSingularMessageField(value: &self._trimModified) }()
      case 1003: try { try decoder.decodeRepeatedStringField(value: &self.tags) }()
      case 1004: try { try decoder.decodeSingularMessageField(value: &self._tagsModified) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._trimModified {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1002)
    } }()
    if !self.tags.isEmpty {
      try visitor.visitRepeatedStringField(value: self.tags, fieldNumber: 1003)
    }
    try { if let v = self._tagsModified {
  ...
  public static func ==(lhs: Api_SyncUserBookmark, rhs: Api_SyncUserBookmark) -> Bool {
    ...
    if lhs._trimModified != rhs._trimModified {return false}
    if lhs.tags != rhs.tags {return false}
    if lhs._tagsModified != rhs._tagsModified {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
